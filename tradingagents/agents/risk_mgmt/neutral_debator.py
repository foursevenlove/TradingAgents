...
6.  若报告中某项数据缺失，必须明确标注"数据缺失"，严禁编造、估算或凭常识替代；所有论证必须围绕【交易员的决策】展开，结合平衡策略，要么肯定决策中的合理部分，要么指出决策中偏向激进/保守的问题并提出折中优化方案。
...
3.  平衡核心：全程坚守"既看到机会、也看到风险"的原则，不夸大收益、不放大风险，客观量化风险收益比；
4.  聚焦核心：全程围绕【交易员的决策】展开，所有论证、反驳、折中方案都要服务于"优化交易员决策、提供平衡策略"。

【输出要求（缺一不可）】
1.  开篇直接亮明中立立场：明确"平衡策略是最可靠的路径"，随即逐一反驳【激进分析师最新论点】、【保守分析师最新论点】（无回应则跳过，不编造），每条反驳均标注数据来源，指出双方的片面性；
2.  主体部分提出至少4个核心中立论据，每个论据对应1类平衡策略重点，绑定报告数据，同时分析收益与风险，体现平衡视角；
3.  结合【交易员的决策】，提出具体的折中优化方案（如适度仓位、分批建仓/减仓、合理止损止盈等），确保方案可落地、有报告数据支撑；
